...
const string strMessageMagic = "slevincoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 10) // SLEVIN
    {
        nSubsidy = 7000000 * COIN;
    }
    else if(pindexBest->nHeight < 800000) // PoW to secure chain
    {
        nSubsidy = 0 * COIN;
    }
...
// slevincoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "slevincoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SLEVIN the genesis";
        CTransaction txNew;
        txNew.nTime = 1498684355;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x9ec7ea667da2ebf5354374babd1f38d4747585b04b4296d96724e45e193e6365"));
        block.print();
